...
set ININAME=XenonEffects.ini
set FOLDERNAME=.
IF NOT "%~1"=="" set FOLDERNAME="%1"
IF NOT "%~2"=="" set ININAME="%2"

<nul (set/p nlv=[TPK])> %ININAME%                              & ECHO(>> %ININAME%
<nul (set/p nlv=Name = XENONEFFECTS)>> %ININAME%        & ECHO(>> %ININAME%
<nul (set/p nlv=Version = 5)>> %ININAME%                       & ECHO(>> %ININAME%
<nul (set/p nlv=Filename = XenonEffects.ini)>> %ININAME%    & ECHO(>> %ININAME%
<nul (set/p nlv=FilenameHash = 0x)>> %ININAME%
strhash XenonEffects.ini>> %ININAME%
ECHO(>> %ININAME%
...
<nul (set/p nlv=ClassNameHash = 0x6B6D324C)>> %ININAME%          & ECHO(>> %ININAME%
<nul (set/p nlv=ImageCompressionType = 0x20)>> %ININAME%       & ECHO(>> %ININAME%
...
<nul (set/p nlv=RenderingOrder = 0)>> %ININAME%                & ECHO(>> %ININAME%
...
<nul (set/p nlv=AlphaBlendType = 2)>> %ININAME%                & ECHO(>> %ININAME%
